...
import { createTargetTitle } from "./actions";

export default function NewTargetTitlePage() {
  return (
    <main className="min-h-screen bg-[#020817] text-white px-6 py-10">
      <div className="mx-auto max-w-2xl">
        <div className="mb-8 flex items-start justify-between gap-4">
          <div>
            <h1 className="text-4xl font-bold tracking-tight">Add Target Title</h1>
            <p className="mt-2 text-slate-300">Add one role target at a time.</p>
          </div>
